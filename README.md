...
# To-do
- Improve initial load times for menus. (the very first cold launch will always be slightly slower as it loads the daemon, unless you have the daemon in your compositor's autostart list)
